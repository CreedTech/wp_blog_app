...
class AllureWomanScreen extends StatefulWidget {
  const AllureWomanScreen({Key? key}) : super(key: key);

  @override
  _AllureWomanScreenState createState() => _AllureWomanScreenState();
}

class _AllureWomanScreenState extends State<AllureWomanScreen> {
  WpApi api = WpApi();
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: FutureBuilder(
            future: api.fetchOtherCategories(15750),

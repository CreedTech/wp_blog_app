...
class AfricanPrintScreen extends StatefulWidget {
  const AfricanPrintScreen({Key? key}) : super(key: key);

  @override
  _AfricanPrintScreenState createState() => _AfricanPrintScreenState();
}

class _AfricanPrintScreenState extends State<AfricanPrintScreen> {
  WpApi api = WpApi();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text("African Print"),
        backgroundColor: isThemeChange.mTheme ? colorsBlack : colorWhite,
      ),

...
class AtaAshiruScreen extends StatefulWidget {
  const AtaAshiruScreen({Key? key}) : super(key: key);

  @override
  _AtaAshiruScreenState createState() => _AtaAshiruScreenState();
}

class _AtaAshiruScreenState extends State<AtaAshiruScreen> {
  WpApi api = WpApi();
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: FutureBuilder(
            future: api.fetchOtherCategories(34),

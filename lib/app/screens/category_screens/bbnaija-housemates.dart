...
class BBNaijaHouseMatesScreen extends StatefulWidget {
  const BBNaijaHouseMatesScreen({Key? key}) : super(key: key);

  @override
  _BBNaijaHouseMatesScreenState createState() => _BBNaijaHouseMatesScreenState();
}

class _BBNaijaHouseMatesScreenState extends State<BBNaijaHouseMatesScreen> {
  WpApi api = WpApi();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text("BB Naija Housemates"),
        backgroundColor: isThemeChange.mTheme ? colorsBlack : colorWhite,
      ),
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: FutureBuilder(
            future: api.fetchOtherCategories(22786),

...
class BridalStyleScreen extends StatefulWidget {
  const BridalStyleScreen({Key? key}) : super(key: key);

  @override
  _BridalStyleScreenState createState() => _BridalStyleScreenState();
}

class _BridalStyleScreenState extends State<BridalStyleScreen> {
  WpApi api = WpApi();
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: FutureBuilder(
            future: api.fetchOtherCategories(42),

...
class AllureMagazineScreen extends StatefulWidget {
  const AllureMagazineScreen({Key? key}) : super(key: key);

  @override
  _AllureMagazineScreenState createState() => _AllureMagazineScreenState();
}

class _AllureMagazineScreenState extends State<AllureMagazineScreen> {
  WpApi api = WpApi();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text("Allure Magazine"),
        backgroundColor: isThemeChange.mTheme ? colorsBlack : colorWhite,
      ),
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: FutureBuilder(
            future: api.fetchOtherCategories(3),

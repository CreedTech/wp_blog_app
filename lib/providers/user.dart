...
class UserProvider extends ChangeNotifier {
  ...
  bool isFavorite(int articleId) => _favorites.contains(articleId);
  ...
  bool isBookmarked(int articleId) => _bookmarks.contains(articleId);
  ...
  bool isHidden(int articleId) => _trash.contains(articleId);
}
